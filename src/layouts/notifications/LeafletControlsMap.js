  ...
  return (
    <MDBox
      ...
      sx={{
        ...
        height: `calc(100vh - 90px)`, // Occupy almost the full screen height
        marginBottom: "0px",
      }}
    >
        ...
        <Grid item xs={12} sm={12} md={4} lg={3} xl={3}>
          <MDBox
            ...
            sx={{
              ...
              // ... (Styles for date picker and form controls, omitted for brevity)
          ...
          >
            ...
            <MDButton
              ...
              color="primary"
              fullWidth
              onClick={handleTrackSubmit} // ⭐ API Call is here
                    ...
                    return (
                      ...
                      >
                        ...
                        <MDBox
                          component="label"
                          sx={{
                            // ... (Toggle switch styles, omitted for brevity)
                            position: "relative",
            ...
            {/* End of Conditional History/Controls */}
          </MDBox>
        </Grid>
